  ...
  return (
    <>
      <section className="hero">
        ...
        <div className="shell hero__content">
          ...
          <div className="hero__specs">
            <span>
              <strong>496 HP</strong>Công suất tối đa
            </span>
            <span>
              <strong>4,9 giây</strong>Tăng tốc 0–100 km/h
            </span>
            <span>
              <strong>4MATIC</strong>Dẫn động 4 bánh
            </span>
          </div>
          <div className="hero__actions">
            <Link
              href="/cars/mercedes-benz-s-450-l"
              className="button button--primary button--lg"
            >
              Khám phá xe →
            </Link>
            <Link href="/test-drive" className="button button--outline">
              Đặt lịch lái thử
            </Link>
          </div>
        </div>
      ...
      <section className="section section--dark" id="featured">
        <div className="shell">
          <div className="section-heading">
            <div>
              <p className="eyebrow">Xe nổi bật</p>
              <h2>
                Những mẫu xe đặc biệt.
                <br />
                Sẵn sàng cho bạn.
              </h2>
            </div>
      ...
      <CategoryScrollGallery
        items={categories.map(([name, description], index) => ({
          name,
          description,
          image: vehicles[index]?.image ?? vehicles[0]!.image,
        }))}
      />
      ...
      <section className="experience">
        <div className="shell experience__grid">
          <div className="experience__copy">
            ...
            <h2>
              Hiệu suất. Nghệ thuật chế tác.
              <br />
              Một tương lai tốt đẹp hơn.
            </h2>
            <p>
              Chúng tôi mang đến nhiều hơn một chiếc xe — chúng tôi kiến tạo
              hành trình bằng sự am hiểu, minh bạch và tiêu chuẩn dịch vụ khác
              biệt.
            </p>
            <Link href="/showroom" className="button button--primary">
          ...
          <div className="experience__tiles">
            <article>
              <Sparkles />
              <strong>Hiệu suất mạnh mẽ</strong>
              <span>Được chế tác để chinh phục.</span>
            </article>
            <article>
              <BadgePercent />
              <strong>Nghệ thuật chi tiết</strong>
              <span>Từng chi tiết tạo nên huyền thoại.</span>
            </article>
            <article>
              <ShieldCheck />
              <strong>An tâm vượt trội</strong>
              <span>Bảo hành và hậu mãi toàn diện.</span>
            </article>
          </div>
        </div>
      </section>
      ...
      <section className="lead-strip">
        <div className="shell lead-strip__inner">
          <div>
            <p className="eyebrow">Để chúng tôi tìm chiếc xe phù hợp cho bạn</p>
            <h2>
              Bắt đầu hành trình
              <br />
              cùng AURELIA.
